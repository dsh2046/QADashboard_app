...
cwd = os.getcwd()
Run_Info = {'run_name': 'Product_A_run4', 'product_name': 'Product_A', 'os': 'Linux', 'test_type': 0, 'build_info': 'NA',
        'start_time': date, 'end_time': date, 'total': 18, 'status': 0, 'log_file': 'http://www.google.com', 'test_comment': 'NA', 'area': 'Area1'}
